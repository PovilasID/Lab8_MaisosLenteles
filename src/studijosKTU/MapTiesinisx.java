...
public class MapTiesinisx<Key, Value> extends MapTiesinis<Key, Value> implements MapADTx<Key, Value> {

    private Key baseKey;       // bazinis objektas skirtas naujų kūrimui
    private Value baseObj;       // bazinis objektas skirtas naujų kūrimui

    public MapTiesinisx(Key baseKey, Value baseObj) { // konstruktorius su bazinio objekto
        this(baseKey, baseObj, DEFAULT_HASH_TYPE);
    }

    public MapTiesinisx(Key baseKey, Value baseObj, HashType ht) { // konstruktorius su bazinio objekto
        this(baseKey, baseObj, DEFAULT_INITIAL_CAPACITY, ht);
    }

    public MapTiesinisx(Key baseKey, Value baseObj, int initialCapacity, HashType ht) { // konstruktorius su bazinio objekto
        this(baseKey, baseObj, initialCapacity, DEFAULT_LOAD_FACTOR, ht);
    }

    public MapTiesinisx(Key baseKey, Value baseObj, int initialCapacity, float loadFactor, HashType ht) { // konstruktorius su bazinio objekto
